            ...
            foreach (var fileInfo in currentFiles)
            {
                ...
                .Contains(fileInfo.Extension.ToLower()))
                {
                    ...
                    if (fileInfo.Length / 1024 / 1024 < 1)
                        lengthDirectory = new DirectoryInfo(documentDirectory + "Менее 1МБ\\");
                    else if (fileInfo.Length / 1024 / 1024 > 10)
                        lengthDirectory = new DirectoryInfo(documentDirectory + "Более 10МБ\\");
                    else
                        lengthDirectory = new DirectoryInfo(documentDirectory + "От 1 до 10МБ\\");
